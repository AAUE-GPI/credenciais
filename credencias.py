"""
AAUE GPI CREDENCIAS
Podemos pegar neste script e modificar para ter um gui ou podemos chamar isto com os argumentos necesarios testar ambos por perfonmance


Parte da db:
nao faço puta de ideia
"""
...
foto = Image.open('foto.jpg')# <---- input
